...
async function openSequenceEditor(initial) {
    const panel = vscode.window.createWebviewPanel('sequenceEditor', initial ? `Edit Sequence: ${initial.name}` : 'Add New Sequence', vscode.ViewColumn.Active, {
        enableScripts: true,
    });
...
function getEditorHtml(webview, initial, nonce) {
